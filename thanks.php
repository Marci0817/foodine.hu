<?php
    ...
    $sql = "SELECT pont FROM users WHERE username = ?";
    ...
    if(isset($_POST["back_site"])){
        unset($_SESSION["thanks"]);
        header("location: index.php");
    }
    if(isset($_POST["back_recipe"])){
        unset($_SESSION["thanks"]);
...
<html>
    ...
    <body>
        ...
        <div id="tart_alom">
            <h3>Recept felöltés</h3>
            <hr>
            <div id="tart_alom2">
                <p>Köszönjük, hogy idejét áldozta a recept feltöltésével. Rettentően hálásak vagyunk, ezért 5 pontot jóváírunk. ( A pontrendszerünk működésért kattintson <a href="pointlist.php" target="_blank" title="Ha rákattint új oldalon fog megnyílni.">ide</a>! )
                <br>
                Jelenleg <?php echo $points;?> pontja van.
                </p>
                <div style="text-align:center;"><iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdqRaTIaArQXOY5rbpWFrmDXJ_6vaEK3nNmNRuAbd4-vwq4MQ/viewform?embedded=true" width="640" height="1358" frameborder="0" marginheight="0" marginwidth="0">Betöltés…</iframe></div>
                <br><br>
                <form action="" method="post" style="text-align:center;">
                    <input type="submit" name="back_recipe" class="btn btn-outline-success" value="Még egy receptet szeretnék feltölteni"><br><br>
                    <input type="submit" name="back_site" class="btn btn-outline-danger" value="Vissza a főoldalra">
                </form>
            </div>
        </div>
