        ...
        <div id="pointlist">
            ...
            <div id="pointlist2">
                <div class="alert alert-success" role="alert">
                    <h4 class="alert-heading">NYEREMÉNYJÁTÉK</h4>
                    <hr>
                    <p class="mb-0">Minden recept feltöltése után kivételesen <strong>+5 pontot</strong> adunk.<br>
                    2020.09.01 00:00-ig az első játékosunknak pénz üti a markát. :) Jó feltöltéseket!<br>
                    A nyerteseknek a pénzt csak átutalással tudjuk biztosítani!<br>
                    Nyereményjáték után a pontok nem lesznek nullázva, megéri gyűjtögetni. ;)<br><br>

                    </p>
                    
                </div>
                
                <li>Recept feltöltése <del>+3 pont</del> <span class="badge badge-success" >+5 pont</span></li>
                <li>Hibás recept feltöltése ( viccből feltöltés, nem teljes recept ) -2-től -5 pont-ig terjedhet</li>
            </div>
            <table class="table">
                ...
                <?php 
                    $helyezes = 0;
                    $query = "SELECT * FROM users ORDER BY pont DESC LIMIT 5";  
                ...
                ?>
                    <tr>
                    <th scope="row"><?php echo $helyezes; ?></th>
                    <td><a href="profile.php?id=<?php echo $row['id'];?>"><?php echo $row['username'];?></a></td>
                    <td><?php echo $row['pont'];?></td>
                    <td>
                    <?php
                        if($helyezes == 1){ 
                            echo "<span class='badge badge-success'>+10 000 Forint</span>"; 
                        }/*else if($helyezes == 2){
                            echo "<span class='badge badge-success'>+5 000 Forint</span>"; 
                        }else if($helyezes == 3){
                            echo "<span class='badge badge-success'>+2 000 Forint</span>"; 
                        }*/
                        ?></td>
                    </tr>
                <?php  
